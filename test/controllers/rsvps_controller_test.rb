...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { attending: @rsvp.attending, comment: @rsvp.comment, email: @rsvp.email, guest: @rsvp.guest, name: @rsvp.name }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { attending: @rsvp.attending, comment: @rsvp.comment, email: @rsvp.email, guest: @rsvp.guest, name: @rsvp.name }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
